...
namespace Bank.Tests
{
    ...
    public class KontoLimitTests
    {
        ...
        {
            var acc = new KontoLimit("John", 100, 50);
        ...
        [TestMethod]
        public void Withdraw_UsingLimit_ShouldBlock()
        {
            var acc = new KontoLimit("John", 100, 50);
        ...
        [TestMethod]
        public void Deposit_AfterLimitUse_ShouldUnblock()
        {
            var acc = new KontoLimit("John", 100, 50);
        ...
        [TestMethod]
        public void Limit_SetNegative_ShouldThrow()
        {
            var acc = new KontoLimit("John", 100, 50);
